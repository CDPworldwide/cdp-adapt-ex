...
def get_environment() -> Environment:
    ...
    """
    env_val = os.getenv("APP_ENV", "development").lower()
    print(f"DEBUG: APP_ENV raw value: '{os.getenv('APP_ENV')}'")
    print(f"DEBUG: APP_ENV processed value: '{env_val}'")
    match env_val:
...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "CDP Webapp")
        self.VERSION = os.getenv("VERSION", "1.0.0")
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION",
            "CDP climate data platform webapp",
        )
        self.API_V1_STR = os.getenv("API_V1_STR", "/api/v1")
        self.DEBUG = os.getenv("DEBUG", "false").lower() in ("true", "1", "t", "yes")
        self.SKIP_DATABASE_INIT = os.getenv("SKIP_DATABASE_INIT", "false").lower() in (
            "true",
            "1",
            "t",
            "yes",
        ...
        self.SUPPORTED_TRANSLATION_LANGUAGES = set(
            parse_list_from_env(
