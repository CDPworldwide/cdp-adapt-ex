...
from app.services.interfaces.city_resolution_service import ICityResolutionService
from app.shared.exceptions import MultipleCitiesFoundException


class CityResolutionService(ICityResolutionService):
    def __init__(self, repository: LocationDetailsRepository):
        self.repository = repository

    def resolve_org_id(self, city_name: str) -> Optional[int]:
        ...
        results = self.repository.get_orgs_by_name(city_name)
